            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="${ pageContext.request.contextPath }${ PathConfig.PATH_JOB_EDIT }" 
                            	method="post">
                            	<div class="form-group">
                                    <label class="col-md-12">Mã dự án</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc" value="${ job.id }" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc" value="${ job.name }" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" placeholder="dd/MM/yyyy" value="${ job.startDate }" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" placeholder="dd/MM/yyyy" value="${ job.endDate }" 
